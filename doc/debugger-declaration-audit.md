...
browser-local preferences are sovereign namespace state. Legacy renderer
source remains for compatibility tests, but the native bundle disables its DOM
factories. A build-time check rejects any native application `createElement`
