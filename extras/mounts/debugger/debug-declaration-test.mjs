...
const assets = new Map(await Promise.all([
  ['/debug-mash.js', 'mash.js', 'text/javascript'],
  ['/debug-components.css', 'components.css', 'text/css'],
...
const parser = await esbuild().build({entryPoints:[resolve(root,'namespace.js')],bundle:true,write:false,format:'esm'});
